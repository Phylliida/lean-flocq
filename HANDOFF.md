...
**~24727 lines of Lean across 27 files. 0 `sorry`s. All files build clean.**
...
1. **`Binary.lean` arithmetic ops**: `shr_record` infrastructure DONE
   ...
   **`Bminus` + `Bminus_correct` DONE** (2026-05-15) — derived from
   ...
   vs 510 for `Bplus`). Next: `Bdiv`, `Bsqrt`, then auxiliary ops
